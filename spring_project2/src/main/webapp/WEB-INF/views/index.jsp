...
<div class="jumbotron jumbotron-fluid">
	<div class="container">
	  <h1 class="display-4">Spring Board</h1>	 
	  <hr class="my-4">  
	  ...
	  <c:if test="${!empty info}">
	  <a class="btn btn-primary btn-lg" href="/member/changePw" role="button">비밀번호 변경</a>
	  ...
	  <a class="btn btn-success btn-lg" href="/board/list" role="button">게시판</a>
	  </c:if>
	</div>
</div>
